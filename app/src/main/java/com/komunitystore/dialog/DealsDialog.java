...
public class DealsDialog extends Dialog {
    ...
    public DealsDialog(Context context, JSONArray json) {
    ...
    private void init() {
        ...
        for (int i = 0; i < json.length(); i++) {
            deals.add(gson.fromJson(json.optJSONObject(i).toString(), Deal.class));
        }
        _adapter = new DealAdapter(getContext(), deals, DealAdapter.Type.FULL);
